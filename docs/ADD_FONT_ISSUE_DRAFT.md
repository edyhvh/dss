...
- Latin Core check against official `GF_Latin_Core.txt`: 100/324 glyph names present (224 missing).
- I am submitting first for Hebrew review and guidance on next steps.

**Prepared family package (for google/fonts `ofl/deadseascrolls/`):**
